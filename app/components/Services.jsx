import { SquareCode, Rocket, Terminal,Brain } from "lucide-react"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3  p-5 md:w-[80%] mx-auto text-white mt-[4rem] items-center gap-[2rem] " >
                ...
                <div>
                    <div className="bg-blue-700 hover:scale-110 transform transition-all duration-300 hover:rotate-6 uppercase text-center font-semibold p-[2rem] min-h-[380px]" data-aos="fade-left">
                        <Brain className="w-[6rem] h-[6rem] mx-auto text-[#d3fae8]" />
                        <h1 className="text-[20px] md:text-[30px] mt-[1.5rem] mb-[1.5rem]">AI Agents</h1>
                        <p className="text-[15px] text-[#d3d2d2] font-normal">
                            Proficient in designing and deploying AI agents, intelligent chatbots, and automation workflows to deliver smart, adaptive, and efficient solutions.
                        </p>
                    </div>
                </div>
